...
\noindent This paper does not require a great deal of prior knowledge in order to be understood. In fact, anyone who is familiar with how to prove things should have the background knowledge required to read through this paper. In this section we shall lay out the notation we shall be using an any previous knowledge we expect the reader to have. For the most part, this paper will stick to the standard notation used within mathematics today.
