...
\label{corollary:redundancy_divisible_by_gcd}
\hypertarget{definition:redundancy_divisible_by_gcd}{}
\begin{tcolorbox}
\textbf{Corollary}

For any redundant awkward number series $S_{a,n}$, for any $s_i \in S_{a, n}$, it is the case that $s_i$ is divisible by $gcd(a,n)$.
