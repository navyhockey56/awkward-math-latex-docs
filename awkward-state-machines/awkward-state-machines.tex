...
Now that we know a bit about cycle graphs, we shall continue to build our understanding of the components of awkward state machines by extending our ideas about cycle graphs in to create activation cycle machines.\\
\\
\textbf{Definition}
